...
- `1_success_rate.png` - Success rate by strategy (62.7% freeform, 57.3% none, 56.0% structured)
- `2_communication_volume.png` - Messages + tokens per run (dual chart with tiktoken o200k_base counting)
- `3_collision_rate.png` - Average collisions per run with standard deviation
- `4_completion_timeline.png` - Cumulative agents finished over 100 turns
- `5_success_vs_tokens.png` - Scatter plot of task success vs communication cost

Generated by `generate_plots_45runs.py` (adapted from `analysis/claude_generate_plots.py`)
