...
**Last updated:** 2025-11-14T19:15:00Z
...
## Results (45 runs - 5 seeds × 3 strategies × 3 replicates)

| Strategy | Success Rate | Avg Messages/Run (±std) | Avg Finished Agents (±std) |
|----------|--------------|------------------------|---------------------------|
| **Freeform** | 62.7% (47/75 agents, 15 runs) | 6.3 ± 9.0 | 3.13 ± 1.36 |
| **None** | 57.3% (43/75 agents, 15 runs) | 0.0 ± 0.0 | 2.87 ± 1.41 |
| **Structured** | 56.0% (42/75 agents, 15 runs) | 8.3 ± 6.5 | 2.80 ± 1.32 |
