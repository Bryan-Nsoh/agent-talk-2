...
| seed14 | complete | 3/5 finished; collisions 0 |
| seed15 | complete | 4/5 finished; collisions 0 |
| seed16 | complete | all 5 finished; collisions 0 |
| seed17 | complete | all 5 finished; collisions 0 |
...
## Interpretation
No sharing still achieves full completion in most seeds (3/5) with zero collisions; completions are slower than global but faster than radio_sync.

## Decision
Use as baseline for map-sharing comparisons.

## Hypothesis Register
- H1: With map_sharing=none, success and collisions will match the historical no-share baseline; any deviation indicates engine or prompt regressions. Metrics: agent completion rate, collisions per run, turns to first finish.
