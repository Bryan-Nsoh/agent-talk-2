...
All curve plots available in `analysis/mapshare/plots/`:

- **1_success_rate.png** - Success rate comparison across modes
- **2_goal_discovery_sync.png** - Goal discovery timing patterns
- **3_cumulative_finishes.png** - Agent completion over time
- **4_map_knowledge_growth.png** - Unknown cells declining over turns
- **5_collision_cost.png** - Collision frequency comparison
